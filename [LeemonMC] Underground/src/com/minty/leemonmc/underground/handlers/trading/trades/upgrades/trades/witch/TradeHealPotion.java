...
public class TradeHealPotion extends Trade {
	
	private Underground main = Underground.getInstance();
	
	public TradeHealPotion(TradeCategory category)
	{
		super(category);
	}
	...
	{
		return "§6Potion de soin jetable";
	}
	...
	public ItemStack getIcon(Player player)
	{
		...
		PotionEffect potionEffect = new PotionEffect(PotionEffectType.HEAL, 20 * 20, 2 - 1);
		
		meta.setDisplayName("§fPotion de soin instantané II");
