...
public class TradeRegenPotion extends Trade {
	
	private Underground main = Underground.getInstance();

	public TradeRegenPotion(TradeCategory category)
	{
		super(category);
	}
	...
	{
		return "§6Potion de régénération";
	}
	
	@Override
	public String getDescription()
	{
		return "§7De quoi vous ravitailler durant vos combats.";
	}
	...
	public ItemStack getIcon(Player player)
	{
		...
		PotionEffect potionEffect = new PotionEffect(PotionEffectType.REGENERATION, 20 * 30, 1 - 1);
		
		meta.setDisplayName("§fPotion de régénération");
